...
func (c *helloWorldServiceClient) SayHello(ctx context.Context, in *SayHelloRequest, opts ...grpc.CallOption) (*SayHelloResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/basic.v1.HelloWorldService/SayHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _HelloWorldService_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/basic.v1.HelloWorldService/SayHello",
	}
...
var HelloWorldService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "basic.v1.HelloWorldService",
	...
	Metadata: "basic/v1/hello_world.proto",
}
